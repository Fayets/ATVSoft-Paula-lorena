  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex justify-end gap-3 pt-3">
        ...
        <button onClick={() => onSave(form)} className="rounded-lg bg-[var(--auth-cta-bg)] px-5 py-2.5 text-[11px] font-semibold uppercase text-[var(--auth-cta-text)]">Guardar</button>
      </div>
    </div>
  )
}
